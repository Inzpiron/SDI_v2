...
export PATH=$PATH:/usr/local/hadoop/bin/:/usr/local/hadoop/sbin:$PATH
...
export PATH=/usr/local/netbeans-8.2/bin:$PATH
...
#export PATH=/usr/local/openmpi-3.1.0/bin:$PATH
#export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/openmpi-3.1.0/lib/
...
alias la='ls -A'
alias l='ls -CF'
alias mpirun='mpirun -mca btl ^openib '
